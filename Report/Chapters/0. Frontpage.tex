\begin{titlepage}
    ...
    \begin{tikzpicture}
        ...
        \node[opacity=0.2,inner sep=0pt,remember picture,overlay] at (4.5,-0.5){\includegraphics[width= 0.8 \textwidth]{Figures/0. General/us-giraldillo-grey.png}};
    ...
    \tikz[remember picture,overlay]\node[anchor=south,inner sep=10pt] at (current page.south) {\includegraphics[width=\paperwidth]{Figures/0. General/us-bg.jpg}};
